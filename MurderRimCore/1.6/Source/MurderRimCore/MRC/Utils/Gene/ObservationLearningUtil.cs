    ...
    public static class ObservationLearningUtil
    {
        ...
        public static void TryPlayObservationEffecter(Pawn watcher, float observedXpGranted, ObservationLearningExtension ext)
        {
            ...
            if (effDef == null)
            {
                ...
                {
                    Log.Error("[MurderRimCore] Observation effecter missing: " + tag);
                }
                return;
            }
            ...
            {
                MurderRimCore_ObservationEffecterManager.Instance.EnsureAttached(
                    watcher,
                    effDef,
            ...
            else
            {
                ...
                {
                    Log.Warning("[MurderRimCore] Failed to trigger observation effecter: " + e);
                }
            }
        }
