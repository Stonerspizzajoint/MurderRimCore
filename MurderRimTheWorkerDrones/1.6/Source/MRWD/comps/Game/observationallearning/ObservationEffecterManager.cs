...
namespace MRWD
{
    ...
    public class ObservationEffecterManager : GameComponent
    {
        ...
        public ObservationEffecterManager() { }
        public ObservationEffecterManager(Game game) { }

        public static ObservationEffecterManager Instance
        {
            get
            {
                var game = Verse.Current.Game; // Current is static; Game may be null early
                return game != null ? game.GetComponent<ObservationEffecterManager>() : null;
            }
        }
